...
;; ==================================================================
;; Adds the log to the database in the collection statusUpdates.
;; ==================================================================
(defn addUpdate! [stamp & args]
  (let [conn (mg/connect {:host hostname})
        db (mg/get-db conn dbname)
        collname "statusUpdates"
        message (string/join " " (reduce str args))]
    (try (mc/insert db collname {:stamp stamp :content message}))
    )
  )
;; ==================================================================
